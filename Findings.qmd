...
In contrast, marine and terrestrial functional groups show substantially higher proportions of Least Concern classifications at both GET levels. However, this disparity warrants cautious interpretation. The pattern reflects both genuinely lower pressure intensities in some remote or less-utilized systems and data deficiencies in threat assessment for exploited ecosystems, suggesting that threat status for certain marine and terrestrial functional units may be underestimated.
