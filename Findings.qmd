...
When summarized at the realm level, freshwater ecosystems are disproportionately threatened across both IUCN GET classification levels. At GET Level 2 (functional biomes), 75% of inland aquatic realms including rivers and wetlands, as well as estuarine systems are classified as threatened. At GET Level 3 (ecosystem functional groups), freshwater realms show the highest concentration of threats: river groups account for 75% and wetlands 72% of threatened classifications, while estuarine groups account for 71%. These convergent patterns reflect widespread degradation of freshwater and transitional ecosystems under multiple pressures, including hydrological disruption (damming, water extraction, altered flows), declining water quality (pollution and eutrophication), and, in estuaries, intensive fishing pressure.

In contrast, marine and terrestrial functional groups show substantially higher proportions of Least Concern classifications at both GET levels. However, this disparity warrants cautious interpretation. The pattern reflects both genuinely lower pressure intensities in some remote or less-utilized systems and significant data deficiencies in threat assessment for exploited ecosystems, suggesting that threat levels for certain marine and terrestrial functional groups may be underestimated.
