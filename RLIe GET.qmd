...
EDD <- read.csv("./data/EDDFullfile_L4L5_V4_17092025s.csv") %>%
      ...
      mutate(GET_L2.text = case_when(IUCN_GET_2025_L2 == "T1" ~ "Tropical-subtropical forests", 
                                     ...
                                     IUCN_GET_2025_L2 == "T7" ~ "Intensive land-use systems",
                                     IUCN_GET_2025_L2 == "T8" ~ "Intensive land-use systems",
                                     IUCN_GET_2025_L2 == "MT2" ~ "Supralittoral coastal systems", 
                                     TRUE ~ "")) %>%

      mutate(GET_L3.text = case_when(IUCN_GET_2022_L3 == "T1.1" ~ "Tropical-subtropical lowland rainforests", 
                                     IUCN_GET_2022_L3 == "T1.2" ~ "Tropical-subtropical dry forests and thickets", 
                                     IUCN_GET_2022_L3 == "T1.3" ~ "Tropical-subtropical montane rainforests", 
                                     IUCN_GET_2022_L3 == "T1.4" ~ "Tropical heath forests", 
                                     IUCN_GET_2022_L3 == "T2.1" ~ "Boreal and temperate high montane forests and woodlands", 
                                     IUCN_GET_2022_L3 == "T2.2" ~ "Deciduous temperate forests", 
                                     IUCN_GET_2022_L3 == "T2.3" ~ "Oceanic cool temperate rainforests", 
                                     IUCN_GET_2022_L3 == "T2.4" ~ "Warm temperate laurophyll forests", 
                                     IUCN_GET_2022_L3 == "T2.5" ~ "Temperate pyric humid forests", 
                                     IUCN_GET_2022_L3 == "T2.6" ~ "Temperate pyric sclerophyll forests and woodlands", 
                                     ...
                                     IUCN_GET_2022_L3 == "T3.4" ~ "Rocky pavements, screes and lava flows",
                                     IUCN_GET_2022_L3 == "T4.1" ~ "Trophic savannas",
                                     IUCN_GET_2022_L3 == "T4.2" ~ "Pyric tussock savannas",
                                     IUCN_GET_2022_L3 == "T4.3" ~ "Hummock savannas", 
                                     IUCN_GET_2022_L3 == "T4.4" ~ "Temperate woodlands", 
                                     ...
                                     IUCN_GET_2022_L3 == "T5.3" ~ "Sclerophyll hot deserts and semi-deserts",
                                     IUCN_GET_2022_L3 == "T5.4" ~ "Cool deserts and semi-deserts",
                                     IUCN_GET_2022_L3 == "T5.5" ~ "Hyper-arid deserts",
                                     IUCN_GET_2022_L3 == "T6.1" ~ "Ice sheets, glaciers and perennial snowfields", 
                                     IUCN_GET_2022_L3 == "T6.2" ~ "Polar-alpine rocky outcrops",
                                     IUCN_GET_2022_L3 == "T6.3" ~ "Polar tundra and deserts",
                                     IUCN_GET_2022_L3 == "T6.4" ~ "Temperate alpine grasslands and shrublands",
                                     IUCN_GET_2022_L3 == "T6.5" ~ "Tropical alpine grasslands and shrublands",
                                     IUCN_GET_2022_L3 == "T7.1" ~ "Annual croplands",
                                     IUCN_GET_2022_L3 == "T7.2" ~ "Sown pastures and fields",
                                     IUCN_GET_2022_L3 == "T7.3" ~ "Plantations",
                                     IUCN_GET_2022_L3 == "T7.4" ~ "Urban and industrial ecosystems",
                                     IUCN_GET_2022_L3 == "T7.5" ~ "Derived semi-natural pastures and oldfield",
      ...
      select(-c(GET_L2.text, GET_L3.text))
...
combined_data <- data %>%
                 ...
                 mutate(Year = as.numeric(Year),
                        Overall = case_when(Year == 2014 ~ RLE2014.adjusted,
                                            ...
                                            GET_L2 = `GET_L2.code_text`,
                                            GET_L3 = `GET_L3.code_text`) %>%
                select(Realm_GETL1, Code, Fuctional_Groups, GET_L2, GET_L3, Year, Overall) %>%
...
RLIe_plot <- ggplot() +
  ...
  # Scales
  scale_color_manual(name = "IUCN Global Ecosystem \nTypology (Level 2)", values = getL2_colors) +
...
RLIe_plot <- ggplot() +
  ...
  # Scales
  scale_color_manual(name = "IUCN Global Ecosystem \nTypology (Level 3)", values = get_colors) +
  scale_linetype_manual(name = "", values = c("Aggregate" = "dotted"), guide = guide_legend(order = 2)) +
  scale_shape_manual(name = "", values = c("Aggregate" = 20), guide = guide_legend(order = 2)) +
  scale_x_continuous(breaks = unique(RLIe_all$Year)) +
  scale_y_continuous(limits = c(0.4, 1), breaks = seq(0.5, 1, 0.1)) +
