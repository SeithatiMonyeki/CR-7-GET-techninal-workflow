...
EDD <- read.csv("./data/EDDFullfile_L4L5_V4_17092025s.csv") %>%
      ...
      mutate(GET_L2.count = paste0(GET_L2.code_text, " (n = ", n.get_L2, ")"),
             GET_L3.count = paste0(GET_L3.code_text, " (n = ", n.get_L3, ")")) %>%
      select(-c(GET_L2.text, GET_L3.text, n.get_L3, n.get_L2))
