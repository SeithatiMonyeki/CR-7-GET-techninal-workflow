...
calculates the Red List Index of Ecosystems (RLIe) using bootstrap confidence intervals (n = 5000) for (i) GET Level 2 ecosystems by year, (ii) GET Level 3 ecosystems by year, and (iii) a national‐level aggregate by year, and then combines all results into a single dataset for consistent reporting and comparison.
